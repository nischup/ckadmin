...
<div class="content-header">
	<div class="leftside-content-header">
	    <ul class="breadcrumbs">
	        ...
	        <li><a href="{{ route('articles.index') }}"> Add Article </a></li>
	    </ul>
	</div>
</div>
@stop
		...
		<span class="pull-right">
		 ...
		 <div class="panel">
            <div class="panel-content">
				<form action="{{ route('articles.store') }}" method="post" class="form-horizontal form-stripe" enctype="multipart/form-data">
					{{ csrf_field() }}

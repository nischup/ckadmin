...
<div class="content-header">
	<div class="leftside-content-header">
	    <ul class="breadcrumbs">
	        ...
	        <li><a href="{{ route('ckprofile.index') }}"> Career Profile List </a></li>
	    </ul>
	</div>
</div>
@stop
...
<div class="row">
	<div class="col-sm-12">
		<h4 class="section-subtitle">
			<b> Career Profile Lists </b>
		</h4>
		<span class="pull-right">
			<a href="{{ route('ckprofile.create')}}" class="btn btn-success btn-right-side"><i class="fa fa-plus"></i></a>
		</span>
		 <div class="panel">
                    ...
                    <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                        ...
                        <tbody>
                        	...
                        	<tr>
                                ...
                                <td> 
                                <a class="btn btn-transparent" title="" data-original-title="Edit" href="{{ route('ckprofile.edit',$data->id) }}"><i class="fa fa-pencil"></i></a>
                                 {!! Form::open(['method' => 'DELETE','route' => ['ckprofile.destroy', $data->id],'style'=>'display:inline']) !!}

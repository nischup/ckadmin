...
<!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
<!-- RIGHT SIDE TIMELINE-->
<h4 class="section-subtitle "><b>Right side</b> Timeline</h4>
<p class="section-text">Add the class <span class="code">tl-right</span> and it will change the timeline to the right side</p>
<div class="row animated fadeInRight">
    <div class="col-md-8">
        <!--TIMELINE right-->
